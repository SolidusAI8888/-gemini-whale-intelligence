...
class Settings:
    ...
    institutional_13f_max_managers: int = _int("INSTITUTIONAL_13F_MAX_MANAGERS", 50)
    institutional_13f_filings_per_manager: int = _int("INSTITUTIONAL_13F_FILINGS_PER_MANAGER", 2)
    institutional_13f_max_holdings_per_filing: int = _int("INSTITUTIONAL_13F_MAX_HOLDINGS_PER_FILING", 100)
